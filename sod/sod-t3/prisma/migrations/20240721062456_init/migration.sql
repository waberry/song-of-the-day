...
CREATE TABLE "DailySong" (
    "id" TEXT NOT NULL,
    "trackId" TEXT NOT NULL,
    "selectedDate" DATE NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "DailySong_trackId_key" ON "DailySong"("trackId");

-- CreateIndex
CREATE UNIQUE INDEX "DailySong_selectedDate_key" ON "DailySong"("selectedDate");
...
-- AddForeignKey
ALTER TABLE "DailySong" ADD CONSTRAINT "DailySong_trackId_fkey" FOREIGN KEY ("trackId") REFERENCES "Track"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
